import { SocialIcon, SocialLink } from "@/data/links";
...
type SocialIconGridProps = {
  links: SocialLink[];
};

export function SocialIconGrid({ links }: SocialIconGridProps) {
  return (
    <div className="flex justify-center gap-3">
      {links.map((link) => (
        <a
          ...
          title={link.label}
          className={cn(
            "flex h-14 w-14 items-center justify-center border-2 border-black shadow-nb transition-all duration-150 ease-out",
